...
**Update: Sau khi pass được challenge này, mình đọc lại thì nhận thấy source code có cho rightGuessString nằm ở index 57 của list, chính là flareonisallaboutcats. Nên source dưới có thể xem như không cần thiết hoặc cần khi đáp án đúng không được cho sẵn trong source code.**
